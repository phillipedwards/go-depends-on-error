...
{
    [TestpkgResourceType("testpkg:index:StaticPage")]
    public partial class StaticPage : Pulumi.ComponentResource
    {
        ...
        public StaticPage(string name, StaticPageArgs args, ComponentResourceOptions? options = null)
            : base("testpkg:index:StaticPage", name, args ?? new StaticPageArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class StaticPageArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("myEnum")]
        public Pulumi.Testpkg.Access? MyEnum { get; set; }

        public StaticPageArgs()
        {
            MyEnum = Pulumi.Testpkg.Access.@Public;
        }
    }
}
