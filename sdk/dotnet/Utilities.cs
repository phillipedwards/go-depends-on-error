...
namespace Pulumi.Testpkg
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Testpkg.version.txt");
    ...
    internal sealed class TestpkgResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public TestpkgResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
