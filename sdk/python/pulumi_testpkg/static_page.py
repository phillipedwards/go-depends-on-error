...
class StaticPageArgs:
    def __init__(__self__, *,
        ...
        if my_enum is not None:
            pulumi.set(__self__, "my_enum", my_enum)
    ...
    @property
    @pulumi.getter(name="myEnum")
    def my_enum(self) -> Optional['Access']:
        return pulumi.get(self, "my_enum")

    @my_enum.setter
    def my_enum(self, value: Optional['Access']):
        pulumi.set(self, "my_enum", value)
